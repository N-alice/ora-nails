    ...
    <form class="modal-content animate" action="index.php?page=portal" method="post">
        ...
        <div class="container">    
            ...
            <div class="input-group">
                ...
                <input type="text" name="fname" placeholder="First Name" value="<?php echo $_SESSION['user']['first_name']; ?>">
            </div>
            <div class="input-group">
                <label>Last Name</label>
                <input type="text" name="lname" placeholder="Last Name" value="<?php echo $_SESSION['user']['last_name']; ?>">
            </div><br>
            <div class="input-group">
        ...
        <div class="container" style="background-color:#f1f1f1">
            <button type="submit" name="edit_myusers_btn">Edit Profile</button>
